/**
 *
 * @api {get} /uvps Retrieve a list of all UVPS.
 * @apiVersion 1.0.0
 * @apiName GetUVPs
 * @apiGroup UVPs
 * @apiUse GenericError
 *
 * @apiDescription Retrieve a list of UVPs
 *
 * @apiParamExample Example query:
 * GET /uvps HTTP/1.1
 * Retrieve all the created UVPs.
 *
 * @apiParamExample Example fields:
 * GET /uvps?fields=user+method+created_at HTTP/1.1
